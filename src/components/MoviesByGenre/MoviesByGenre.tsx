            ...
            {status === "fulfilled" ? <div>
                    <div className={css.moviesAll}>
                        {moviesByGenre.map(movieByGenre =>
                            <div className={css.movieCard} key={movieByGenre.id}>

                                <img src={`https://image.tmdb.org/t/p/w200${movieByGenre.poster_path}`}
                                     alt="original_title"/>
                    ...
                    <div className={css.buttons}>
                        ...
                        <button className={css.button} disabled={data.page >= 300} onClick={() => lastPage()}>Last page
                        </button>
                    </div>
